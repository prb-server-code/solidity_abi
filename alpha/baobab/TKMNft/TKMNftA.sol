...
contract TKMNftA is ERC721, ERC721URIStorage, Pausable, AccessControl, Ownable {
    ...
    function Burn(uint256 _tokenId, uint16 reason) external whenNotPaused onlyRole(HOLDER_ROLE) {
        _burn(_tokenId);
